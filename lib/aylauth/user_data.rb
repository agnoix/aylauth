...
module Aylauth
  class UserData
    ...
    attr_accessor :approved, :ayla_dev_kit_num, :city, :company, :country, :email, :firstname, :id, :lastname, :oem_id, :phone_country_code, :phone, :state, :street, :zip, :logged_in_at
